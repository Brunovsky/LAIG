...
parse_input(bot/Board/P/Cap/Turn/Options, Response) :-
    sanitize_options(Options, Sanitized),
    Game = game(Board, P, Cap, Turn, Sanitized),
    display_game(Game), !,
...
parse_input(move/Move/Board/P/Cap/Turn/Options, '"invalid_move"') :-
    sanitize_options(Options, Sanitized),
    Game = game(Board, P, Cap, Turn, Sanitized),
    display_game(Game),
    opt_tournament(Sanitized, Tournament),
